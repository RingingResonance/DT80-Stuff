...
;delay to keep line add rate no faster than 30fps
fps30:  push h
        lxi h,fbnkbt    ;Get 30fps by looking at the second bit.
        mvi m,0x00      ;clear this.
fp3:    mov a,m
        ani 0x02        ;looking at 2nd bit
        jz  fp3         ;wait until it's a 1
        pop h
        ret
;#########################################################################################################################
